...
<%
	...
	try {
		...
		FileWriter file = new FileWriter(savePath + "/fairytale/3/" + filename + ".json"); //동화 
	...
	File file1 = new File(savePath + "/wav/3/blob");
	File file2 = new File(savePath + "/wav/3/" + filename + ".wav"); //음성
	...
	try {
		...
		FileWriter file = new FileWriter(savePath + "/info/3/" + filename + ".json"); //파일정보
