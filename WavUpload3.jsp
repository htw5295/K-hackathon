...
<%
	...
	try {
		...
		MultipartRequest multi = new MultipartRequest(request, wavRoot + "wav/3", maxSize, "UTF-8",
				new DefaultFileRenamePolicy());

				Runtime.getRuntime().exec("sudo chmod 777 -R /var/lib/tomcat8/webapps/ROOT/");

				File file3 = new File(wavRoot + "/wav/3/1.wav");
				File file4 = new File(wavRoot + "/wav/3/2.wav"); //음성
				...
				File file1 = new File(wavRoot + "/wav/3/blob");
				File file2 = new File(wavRoot + "/wav/3/1.wav"); //음성
