...
function onload(){
  ...
  loginBtn.style.left=bg03.width-(Ratio*36*3)-loginBtn.width+"px";
  ...
  selectedDodamBtn.style.left = (Ratio*99*2)+(200*Ratio)+"px";
  ...
  unSelectedDiaryBtn.style.left = (Ratio*99*2)+(200*Ratio)+(Ratio*69*2)+selectedDodamBtn.width+"px";
  ...
  unSelectedFairytaleBtn.style.left = (Ratio*99*2)+(200*Ratio)+(Ratio*69*2*2)+unSelectedDiaryBtn.width+selectedDodamBtn.width+"px";
  ...
  unSelectedShopBtn.style.left = (Ratio*99*2)+(200*Ratio)+(Ratio*69*2*3)+unSelectedDiaryBtn.width+selectedDodamBtn.width+unSelectedFairytaleBtn.width+"px";
  ...
  moreDetailBtn.style.left = (Ratio*99*2)+(200*Ratio)+"px";
  }
