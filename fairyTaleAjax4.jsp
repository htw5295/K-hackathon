...
<%
	...
	try {
		...
		FileWriter file = new FileWriter(savePath + "/fairytale/4/" + filename + ".json"); //동화 
	...
	File file1 = new File(savePath + "/wav/4/blob");
	File file2 = new File(savePath + "/wav/4/" + filename + ".wav"); //음성
	...
	try {
		...
		FileWriter file = new FileWriter(savePath + "/info/4/" + filename + ".json"); //파일정보
